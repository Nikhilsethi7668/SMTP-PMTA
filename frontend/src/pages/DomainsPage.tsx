...
const DomainsPage: React.FC = () => {
  ...
  // Replace this static ID with your store-based or API-fetched tenant ID
  ...
  const handleAddDomain = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await api.addDomain(tenantId, newDomain, {
          id: 'admin-user',
          email: '',
          name: '',
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={`DNS Records for ${selectedDomain?.domainName}`}
      >
        {selectedDomain && (
          <div className="space-y-4">
            <p className="text-gray-300">
              Add these records to your domain's DNS settings. It may take some time for them to
              propagate.
            </p>
            ...
            <DnsRecordRow
              type="TXT"
              host={selectedDomain.dkimRecord}
              value={selectedDomain.dkimPublicKey}
            />
