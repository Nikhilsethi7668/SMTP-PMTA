...
const SendMessagePage: React.FC = () => {
    ...
    // Replace with your tenant source (localStorage, env, etc.)
    const tenantId = 'default-tenant-id';
    const smtpId = `smtp_${tenantId}`;
    ...
    const handleSend = async (e: React.FormEvent) => {
        ...
        setSuccess('');
        try {
            await api.sendMessage(tenantId, smtpId, subject, recipients);
                ...
                <form onSubmit={handleSend} className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            id="body"
                            rows={10}
                            className="w-full bg-gray-900 border border-gray-700 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 p-2"
