...
import { LayoutDashboard, Users, Send, Settings, Mailbox, X, Ban, Globe, FileText, FileCode } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, setOpen }) => {
    ...
    return (
        <>
            ...
            />
            {/* Sidebar */}
            <div className={`fixed inset-y-0 left-0 flex flex-col w-64 bg-gray-800 border-r border-gray-700 z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
